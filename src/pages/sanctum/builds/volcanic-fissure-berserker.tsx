...
const BuildPage = () => {
  const buildData = {
    ...
    youtubeVideos: [
      {
        url: "m_2QxnnOtSU",
        creator: "TheMehmetBozlak",
        channelUrl: "https://www.youtube.com/@TheMehmetBozlak",
      },
      {
        url: "DSBdlq_3cg4",
        creator: "Ziz feat Goratha",
        channelUrl: "https://www.youtube.com/channel/UCqAJ4uINwVtBXnKT_DzRwHw",
      },
    ],
